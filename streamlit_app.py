...
def calculate_predictions():
    ...
    if st.sidebar.button("Submit Prediction"):
        ...
        home_expected_goals = st.sidebar.number_input("Home Team Expected Goals", value=1.28, format="%.2f")
        away_expected_goals = st.sidebar.number_input("Away Team Expected Goals", value=2.47, format="%.2f")
