...
def calculate_predictions():
    ...
    if st.sidebar.button("Submit Prediction"):
        ...
        home_expected_goals = st.sidebar.number_input("Home Team Expected Goals", value=0.96, format="%.2f")
        away_expected_goals = st.sidebar.number_input("Away Team Expected Goals", value=1.30, format="%.2f")
        ...
        st.write(f"**Most Likely HT/FT:** {most_likely_ HT/FT} - Probability: {most_likely_ HT/FT:.2f}%")
